...
export default function AIActionCard({
    icon, title, subtitle, colors, onPress,
}: {
        ...
        >
            ...
            >
                {diag > 0 && (
                    ...
                    >
                        <Animated.View style={[{ width: diag * 2, height: "100%" }, sweepStyle]}>
                            <LinearGradient
                ...
                <View style={{ position: "absolute", inset: 0, padding: 16 }}>
                    ...
                    <Text className="text-white text-[13px] font-semibold mb-0.5">{title}</Text>
