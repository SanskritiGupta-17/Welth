...
import { View, Text, KeyboardAvoidingView, ScrollView, TextInput, TouchableOpacity, ActivityIndicator, Image } from "react-native";

export default function SignIn() {
    const { signIn, errors, fetchStatus } = useSignIn();
    const router = useRouter();

    const { control, handleSubmit, formState: { errors: formErrors } } = useForm<SignInFormSchema>({
        ...
        >
            ...
            >
                <View className="px-6 py-10">
                    ...
                    <Text className="text-3xl font-bold text-[#1A1D26] mb-2 leading-tight">Welcome back</Text>
                    <Text className="text-brand-text-muted text-base mb-8">Sign in to your account</Text>
                    ...
                    <TouchableOpacity
                        ...
                        disabled={isLoading}
                        className="w-full bg-brand-blue py-3 rounded-xl items-center mb-4">
                        {isLoading ? (
                            <ActivityIndicator color="white" />
                        ) : (
